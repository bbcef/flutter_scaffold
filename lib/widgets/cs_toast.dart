...
//CsToastWidget
class CsToastWidget extends StatelessWidget {
  const CsToastWidget({
    Key key,
    @required this.msg,
    this.image,
...
_HideCallback _showCsToast({
  ...
  var backButtonName = 'CsToast$backButtonIndex';
