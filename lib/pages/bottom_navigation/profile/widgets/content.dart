...
class _ProfileContentState extends State<ProfileContent> {
  List _list(){
    ...
    return [
      ...
      {'icon':Icon(Icons.image_outlined,size: iconSize,color: iconColor),'text': 'B站热门排行榜', 'route': '/b_movie_list'},
      {'icon':Icon(Icons.image_outlined,size: iconSize,color: iconColor),'text': '插件 - image_picker', 'route': '/image_picker'},
      {'icon':Icon(Icons.image_outlined,size: iconSize,color: iconColor),'text': '插件 - url_launcher', 'route': '/url_launcher'},
